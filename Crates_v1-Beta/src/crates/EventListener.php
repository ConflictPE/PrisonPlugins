 ...
 * EventListener class
 *
 * Created on Mar 16, 2016 at 9:34:37 PM
 *
 * @author Jack
 */
		...
		if($tile instanceof Chest) {
			...
			if($crate instanceof Crate) {
				...
				if(((isset($this->plugin->getKeyData($player->getName())[$id]) ? $this->plugin->getKeyData($player->getName())[$id] : 0)) >= 1) {
					...
					$pk->eid = $eid;
					$pk->metadata = [
						Entity::DATA_FLAGS => [Entity::DATA_TYPE_LONG, [Entity::DATA_FLAG_INVISIBLE, Entity::DATA_FLAG_CAN_SHOW_NAMETAG, Entity::DATA_FLAG_ALWAYS_SHOW_NAMETAG, Entity::DATA_FLAG_IMMOBILE]],
